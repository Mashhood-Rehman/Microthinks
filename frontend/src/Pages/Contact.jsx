...
const Contact = ({ contactRef }) => {
      ...
      <div className="max-w-6xl mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 gap-16">
        ...
        <div className="space-y-6">
          <h2 className="text-3xl  font-bold text-gray-800">
            Get in touch<br />
            with our<br />
            <span className="">specialists today</span>
          </h2>

          <div className="mt-16 space-y-10">
            <div>
              <h3 className="font-bold font-serif text-gray-800 text-lg mb-5">Business Information</h3>
              <p className="text-gray-500">Microthinks Pvt Ltd</p>
              <p className="text-gray-500">Gulberg, Lahore, Pakistan</p>
              <p className="text-gray-500">Email: info@microthinks.com</p>
              <p className="text-gray-500">Phone: +92 308 4512116</p>
            </div>
            ...
            <div className="flex space-x-5 pt-5">
              <a
                href="https://facebook.com/microthinks"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.instagram.com/microthinks"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-500 hover:text-orange-500 transition-transform transform hover:scale-125"
              >
  ...
  <Link to="/PrivacyPolicy" className="text-blue-600 underline ml-1">Privacy Policy</Link>.
</p>
          </form>
        </div>
      </div>
