...
const images = [
  {
    ...
    title: "Expert Team",
    description:
      "Our dedicated professionals ensure your stay exceeds expectations.",
  },
  {
    src: "/ppp.webp",
    alt: "Modern Workspace",
    ...
    description:
      "Experience luxury in the heart of the world's most iconic destinations.",
  },
];
...
export default function OTAPlatforms() {
  ...
  return (
    <section className="container mx-auto py-16 px-4 bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl shadow-lg">
      ...
      >
        <div className="relative group rounded-2xl overflow-hidden shadow-2xl transition-transform duration-300">
        ...
        <div className="space-y-8">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            ...
            satisfaction. Our platform combines cutting-edge technology with
            personalized service to create exceptional digital experiences that
            set your property apart in the competitive hospitality landscape.
          </p>
