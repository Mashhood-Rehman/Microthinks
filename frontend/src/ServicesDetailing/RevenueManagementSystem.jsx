        ...
        <div className="container mx-auto px-4">
              ...
              <div className="w-full md:w-1/2 space-y-6">
                ...
                <div className="space-y-4">
                  <p className="text-gray-600 leading-relaxe">
                    Microthinks cutting-edge technology with years of expertise
                    to deliver Google Ads campaigns that achieve exceptional
                    results. Through advanced keyword research, market analysis,
                    and tailored strategies, we maximize ROI by ensuring your
                    ads reach the right audience and drive measurable outcomes.
                    From crafting compelling ad copy to implementing precise
                    optimizations, we handle every aspect of your Google Ads
                    management with care. Our focus on continuous improvement
                    ensures your campaigns consistently perform at their best,
                    helping you boost visibility, generate leads, or drive sales
                    effectively.
                  </p>
                </div>
              </div>
          ...
          <div className="bg-gray-900 rounded-2xl p-12 text-white text-center transform hover:scale-[1.02] transition-transform duration-300">
            <div className="max-w-3xl mx-auto space-y-8">
              <h2 className="text-4xl font-bold mb-4">Ready For Booking?</h2>
