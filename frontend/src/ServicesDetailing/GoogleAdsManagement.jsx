...
const GoogleAdsManagement = () => {
      ...
      <div className="w-full px-4 lg:px-5 lg:pt-10 pt-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="mt-4 text-xs sm:text-sm md:text-base lg:text-lg text-gray-600 max-w-3xl mx-auto px-2 sm:px-4">
            ...
            hotel's online presence with customized solutions to enrich guests'
            experiences.
          </p>
              ...
              <div className="max-w-6xl mx-auto relative h-[350px] sm:h-[450px]">
                ...
                <div className="absolute left-0 top-1/2 -translate-y-1/2 z-10">
                  <div className="relative w-[200px] sm:w-[280px] h-[150px] sm:h-[190px]">
                    <img src="/g2.webp" alt="Capture demand" className="rounded-lg shadow-xl" />
                ...
                <div className="absolute left-1/2 -translate-x-1/2 top-1/3 z-20">
                  <div className="relative w-[300px] sm:w-[500px] h-[200px] sm:h-[340px]">
                    <img
                      src="/12.gif"
                      alt="Boost visibility"
                ...
                <div className="absolute right-0 top-1/2 -translate-y-1/2 z-10">
                  <div className="relative w-[200px] sm:w-[280px] h-[150px] sm:h-[190px]">
                    <img src="/g4.webp" alt="Drive direct" className="rounded-lg shadow-xl" />
                    <div className="absolute -bottom-3 sm:-bottom-4 left-1/2 -translate-x-1/2 bg-orange-500 text-white px-3 sm:px-4 py-1 sm:py-2 text-xs rounded-full">
                    Optimize Revenue
                    </div>
                  </div>
    ...
    />
      ...
      <div className="min-h-screen bg-white py-12 sm:py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl sm:text-5xl font-serif  text-gray-800"> Dominate with Google Ads</h1>
          {/* About Section */}
            ...
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="w-full md:w-1/2  mt-16 font-serif space-y-6">
                ...
                <p className="text-gray-600  italic leading-relaxed">
                  We combine cutting-edge technology with years of expertise
                  to deliver Google Ads campaigns that achieve exceptional
                  results. From advanced keyword research to precise optimizations,
                  we maximize ROI and drive measurable outcomes for your hotel.
                </p>
              </div>
            </div>
          </div>
  ...
  <div className="flex flex-col md:flex-row-reverse gap-8">
    ...
    <div className="w-full md:w-1/2 mx-5  mt-16 font-serif space-y-6">
      ...
      <p className="text-gray-600  italic leading-relaxed">
      We leverage AI-driven strategies and in-depth analytics to create high-performing Google Ads campaigns. From targeted keyword bidding to precise audience segmentation, we ensure maximum ROI and increased bookings for your hotel.
      </p>
    </div>
  </div>
</div>
