...
const GoogleAdsManagement = () => {
    ...
    <div className="text-gray-900 relative w-full bg-gray-100">
      ...
      <div className="w-full px-4 lg:px-5 lg:pt-10 pt-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          We optimize your hotel's OTA presence with strategic listing enhancements, ensuring higher rankings, increased bookings, and a seamless guest experience.
          </p>
              ...
              <div className="max-w-6xl mx-auto relative h-[350px] sm:h-[450px]">
                ...
                <div className="absolute left-0 top-1/2 -translate-y-1/2 z-10">
                  <div className="relative w-[200px] sm:w-[280px] h-[150px] sm:h-[190px]">
                    <img src="/OTA2.webp" alt="Capture demand" className="rounded-lg shadow-xl" />
                ...
                <div className="absolute right-0 top-1/2 -translate-y-1/2 z-10">
                  <div className="relative w-[200px] sm:w-[280px] h-[150px] sm:h-[190px]">
                    <img src="/OTA6.webp" alt="Drive direct" className="rounded-lg shadow-xl" />
                    <div className="absolute -bottom-3 sm:-bottom-4 left-1/2 -translate-x-1/2 bg-orange-500 text-white px-3 sm:px-4 py-1 sm:py-2 text-xs rounded-full">
    ...
    />
      ...
      <div className="min-h-screen bg-white py-12 sm:py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl sm:text-5xl font-serif  text-gray-800"> Maximize Your Visibility </h1>
          {/* About Section */}
          <div className="bg-white  p-6 md:p-10  mb-8   ">
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="w-full md:w-1/2  mt-16 font-serif space-y-6">
                ...
                Our expert team enhances your hotel's visibility on top OTA platforms with strategic listing management. From compelling descriptions to dynamic pricing, we ensure maximum bookings and revenue growth.
                </p>
              </div>
            </div>
          </div>
  ...
  <div className="flex flex-col md:flex-row-reverse gap-8">
    ...
    <div className="w-full md:w-1/2 mx-5  mt-16 font-serif space-y-6">
      <h2 className="text-3xl sm:text-4xl text-gray-900">
      Boost Conversions with OTA Optimization
      </h2>
      <p className="text-gray-600  italic leading-relaxed">
      We fine-tune every aspect of your OTA listings, leveraging data-driven insights and competitive analysis. Our approach increases rankings, attracts more guests, and maximizes your online revenue potential.
      </p>
    </div>
  </div>
</div>
