...
const GoogleAdsManagement = () => {
    ...
    <div className="text-gray-900 relative w-full bg-gray-100">
      ...
      <div className="w-full px-4 lg:px-5 lg:pt-10 pt-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          We enhance your hotel's brand visibility with targeted social media strategies, ensuring higher engagement, increased bookings, and a strong digital presence.
          </p>
              ...
              <div className="max-w-6xl mx-auto relative h-[350px] sm:h-[450px]">
                ...
                <div className="absolute left-0 top-1/2 -translate-y-1/2 z-10">
                  <div className="relative w-[200px] sm:w-[280px] h-[150px] sm:h-[190px]">
                    <img src="/SM1.webp" alt="Capture demand" className="rounded-lg shadow-xl" />
                ...
                <div className="absolute right-0 top-1/2 -translate-y-1/2 z-10">
                  <div className="relative w-[200px] sm:w-[280px] h-[150px] sm:h-[190px]">
                    <img src="/SM4.webp" alt="Drive direct" className="rounded-lg shadow-xl" />
                    <div className="absolute -bottom-3 sm:-bottom-4 left-1/2 -translate-x-1/2 bg-orange-500 text-white px-3 sm:px-4 py-1 sm:py-2 text-xs rounded-full">
                    Skyrocket Bookings
                    </div>
                  </div>
    ...
    />
      ...
      <div className="min-h-screen bg-white py-12 sm:py-16">
        <div className="container mx-auto px-4">
          <h1 className="text-4xl sm:text-5xl font-serif  text-gray-800"> Boost Your Hotel’s Online Presence</h1>
          {/* About Section */}
          <div className="bg-white  p-6 md:p-10  mb-8   ">
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="w-full md:w-1/2  mt-16 font-serif space-y-6">
                ...
                Elevate Your Hotel’s Brand with Media Marketing
                </h2>
                <p className="text-gray-600  italic leading-relaxed">
                We craft compelling visual content and strategic campaigns to showcase your hotel’s unique experience. From high-quality photography to immersive videos and virtual tours, we create captivating storytelling that highlights your property’s best features. Our media marketing strategies are designed to attract potential guests, enhance brand perception, and drive direct bookings.
                </p>
              </div>
            </div>
          </div>
  ...
  <div className="flex flex-col md:flex-row-reverse gap-8">
    ...
    <div className="w-full md:w-1/2 mx-5  mt-16 font-serif space-y-6">
      <h2 className="text-3xl sm:text-4xl text-gray-900">
      Engage & Inspire with Targeted Media Strategies
      </h2>
      <p className="text-gray-600  italic leading-relaxed">
      Our media marketing approach combines social media, influencer collaborations, and digital storytelling to maximize your hotel's online reach. We create engaging content tailored to your audience, leveraging platforms like Instagram, Facebook, and YouTube to boost visibility. By utilizing data-driven strategies and creative campaigns, we help your hotel increase brand awareness, enhance guest engagement, and drive more reservations.
      </p>
    </div>
  </div>
</div>
